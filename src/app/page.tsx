		...
		<>
			...
			<div>
				<div className="relative isolate">
					<div
						aria-hidden="true"
						className="pointer-events-none absolute inset-x-0 -z-10 -top-40  transform-gpu overflow-hidden blur-3xl sm:-top-80"
					>
						<div
							style={{
								clipPath:
				...
				<div className="mb-12 px-6 lg:px-8">
					<div className="mx-auto max-w-2xl sm:text-center">
						<h2 className="mt-2 font-bold text-4xl text-gray-900 sm:text-5xl">
							Empower your documents, now.
						</h2>
						<p className="mt-4 text-lg text-gray-600">
							Chatting to your documents has never been easier than with PDF-GPT
						</p>
					</div>
				</div>
				...
				<ol className="my-8 space-y-4 pt-8 md:flex md:space-x-12 md:space-y-0">
					...
					<li className="md-flex-1">
						<div className="flex flex-col space-y-2 border-l-4 border-zinc-300 py-2 pl-4 md:border-l-0 md:border-t-2 md:pb-0 md:pl-0 md:pt-4">
							...
							<span className="text-xl font-semibold">Start chatting with your document</span>
							<span className="mt-2 text-zinc-700">It&apos;s that simple. Try PDF-GPT today.</span>
						</div>
					</li>
				</ol>
				{/* Bottom image */}
